...
export default function Home() {
  return (
    <div className="bg-white text-black">
      ...
      {/* Final CTA Section */}
      <section className="relative z-10 bg-black text-white w-full py-20 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-12 relative">
          ...
          {/* Image Section */}
          <div className="relative w-full lg:w-1/2 flex items-center justify-center lg:justify-end h-[400px] lg:h-[500px]">
            <div className="relative w-[250px] sm:w-[300px] md:w-[350px] lg:w-[400px] h-full">
              {/* Shadow */}
              <Image
                src="/shadowtwo.png"
                alt="Shadow"
                width={300}
                height={400}
                className="absolute bottom-0 left-[-40px] z-0 object-contain"
              />
              {/* Phone */}
              <Image
                src="/phone.png"
